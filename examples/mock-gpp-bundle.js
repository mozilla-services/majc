...
`
  ...
  const gppCommands = {
    ...
    addEventListener: function (callback) {
      ...
      window.setTimeout(() => {
        callback({ eventName: "cmpStatus", listenerId: listenerId, data: "loaded", pingData: pingData }, true)

        window.setTimeout(() => {
          callback({ eventName: "signalStatus", listenerId: listenerId, data: "ready", pingData: pingData }, true)

          window.setTimeout(() => {
            callback({ eventName: "cmpDisplayStatus", listenerId: listenerId, data: "visible", pingData: pingData }, true)
          })
        })
      })
    },
