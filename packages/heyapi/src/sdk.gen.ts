...
import type { GetAdsData, GetAdsResponses, GetAdsErrors, GetV1tData, GetV1tResponses, GetV1LogData, GetV1LogResponses, GetV1LogErrors, DeleteV1DeleteUserData, DeleteV1DeleteUserResponses, GetV1ImagesData, GetV1ImagesResponses, GetSpocsData, GetSpocsResponses, DeleteUserData, DeleteUserResponses, GetTilesData, GetTilesResponses, GetTilesErrors } from './types.gen';
...
export const getAds = <ThrowOnError extends boolean = false>(options: Options<GetAdsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<GetAdsResponses, GetAdsErrors, ThrowOnError>({
        url: '/v1/ads',
        ...options,
        headers: {
...
export const getV1T = <ThrowOnError extends boolean = false>(options: Options<GetV1tData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetV1tResponses, unknown, ThrowOnError>({
        url: '/v1/t',
        ...options
    });
};
...
export const getV1Log = <ThrowOnError extends boolean = false>(options?: Options<GetV1LogData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetV1LogResponses, GetV1LogErrors, ThrowOnError>({
        url: '/v1/log',
        ...options
    });
};
...
export const deleteV1DeleteUser = <ThrowOnError extends boolean = false>(options: Options<DeleteV1DeleteUserData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteV1DeleteUserResponses, unknown, ThrowOnError>({
        url: '/v1/delete_user',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const getV1Images = <ThrowOnError extends boolean = false>(options: Options<GetV1ImagesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetV1ImagesResponses, unknown, ThrowOnError>({
        url: '/v1/images',
        ...options
    });
};
...
export const getSpocs = <ThrowOnError extends boolean = false>(options: Options<GetSpocsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<GetSpocsResponses, unknown, ThrowOnError>({
        url: '/spocs',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const getTiles = <ThrowOnError extends boolean = false>(options?: Options<GetTilesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetTilesResponses, GetTilesErrors, ThrowOnError>({
        url: '/v1/tiles',
        ...options
    });
};